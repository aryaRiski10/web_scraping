...
def scrapeData(tableName):
  ...
  #             "hospitality and tourism","human resources","it and software","legal","management and consultancy",
  ...
  for keyword in tqdm(keywords):
    for page in range(1,total_pages):
        ...
        def get_url(keyword):
            ...
            template = 'https://www.kalibrr.com/job-board/co/Indonesia/i/{}/{}'
        ...
        def get_data(job):
            ...
            container = link_soup.find('div',class_=re.compile('k-container md:k-px-4 md:k-mb-12'))
            ...
            requirement = container.find('div',class_=re.compile('k-mb-4.*'), itemprop=re.compile("qualifications"))
  ...
  data_df_for_csv.to_excel(f'data_csv/jobs_data_kalibrr({date_scrape} {len(data_df.index)}).xlsx',index=False)
